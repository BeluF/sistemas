Algoritmo PARCIAL2023temaA
	//datos: la fabrica posee 55 rubros, conocemos el fin del bucle principal (rubros)
	...
	Escribir "DETALLE PRODUCCIÓN 2º SEMANA DE MAYO 2023";
	RUBROS= 55; contador=0; stocktotal=0; menor=9999; mayor= 0;
	Repetir
