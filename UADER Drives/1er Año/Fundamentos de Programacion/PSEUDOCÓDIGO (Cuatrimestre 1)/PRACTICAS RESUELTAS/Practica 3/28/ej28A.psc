...
Algoritmo ej28A		//sin comprobar que los datos estén ordenados
	Definir p1,p2,p3, capital, cuota, totalcapital, totalcomision, maxcomision, comisionvendedor  como real; //porcentaje de polizas
	Definir codigovendedor, polizas, c, totalpolizas , codvendedor, codcomision, maxpolizas como entero;
	
	totalcapital=0; totalpolizas=0; totalcomision=0; maxpolizas=0; maxcomision=0;
